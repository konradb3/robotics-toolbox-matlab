...
%% Jacobiann for each link in robot model
CGen.logmsg([datestr(now),'\tGenerating end-effector jacobian m-function up to joint: ']);
...
%% Jacobian0 for each link in robot model
CGen.logmsg([datestr(now),'\tGenerating base jacobian m-function up to joint: ']);
for iJoint=1:CGen.rob.n
